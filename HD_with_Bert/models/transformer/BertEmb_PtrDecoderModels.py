...
class Decoder(nn.Module):
    ...
    def __init__(
        ...
        if decoder_tied:
            self.tgt_word_prj.weight = self.embeddings.word_embeddings.weight

    def forward(self, tgt_seq, tgt_type, src_seq, enc_output, ext_fea=None, return_attns=False,
        ...
        dec_output = self.embeddings(tgt_seq, tgt_type)  # (bs, len_tgt, d_model)
