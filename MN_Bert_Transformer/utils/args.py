...
def add_argument_base(arg_parser):
    ...
    arg_parser.add_argument('--tagger_rnn', default='GRU', choices=['LSTM', 'GRU', 'RNN'], help='cell of rnn used in tagger')
    arg_parser.add_argument('--dropout', type=float, default=0.05, help='feature dropout rate')
