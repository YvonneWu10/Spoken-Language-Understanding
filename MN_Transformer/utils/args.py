...
def add_argument_base(arg_parser):
    ...
    arg_parser.add_argument('--c_encoder_cell', default='LSTM', choices=['LSTM', 'GRU', 'RNN'], help='encoder cell of current utterance')
    arg_parser.add_argument('--m_encoder_cell', default='LSTM', choices=['LSTM', 'GRU', 'RNN'], help='encoder cell of contextual sentence')
    arg_parser.add_argument('--tagger_rnn', default='LSTM', choices=['LSTM', 'GRU', 'RNN'], help='cell of rnn used in tagger')
    arg_parser.add_argument('--dropout', type=float, default=0.15, help='feature dropout rate')
